...
public class PaymentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            logger.warn("Problem connecting to payment page (IOException)");
            AdminLog logMessage = new AdminLog(CheckoutController.currentDate(), "WARN", "Problem connecting to payment page (IOException)");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.warn("Problem connecting to payment page or redirecting to validation page(IOException)");
            AdminLog logMessage = new AdminLog(CheckoutController.currentDate(), "WARN", "Problem connecting to payment page or redirecting to validation page (IOException)");
            CheckoutController.objectOutputStream.writeObject(logMessage);
            e.printStackTrace();
        }
    }
